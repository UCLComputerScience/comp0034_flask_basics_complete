...
def populate_db():
    ...
    if not Student.query.first():
        ...
        s4 = Student(student_id="CS1234570", email="cs1234570@ucl.co.uk", password="test4pass")
        s5 = Student(student_id="CS1234571", email="cs1234571@ucl.co.uk", password="test5pass")
        s6 = Student(student_id="CS1234572", email="cs1234572@ucl.co.uk", password="test6pass")
        ...
        t4 = Teacher(teacher_id="uclcs0072", title="Dr", first_name="Maximus", last_name="Tierney")
        t5 = Teacher(teacher_id="uclcs0021", title="Dr", first_name="Marcelina", last_name="Mcclure")
        t6 = Teacher(teacher_id="uclcs0132", title="Dr", first_name="Fei Hong", last_name="Zhou")
